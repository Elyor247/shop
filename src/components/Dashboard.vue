          ...
          <v-card height="250px" tile flat color="#6857E1">
            <v-row>
              <v-col cols="12" sm="6" class="pl-8 pt-5">
                ...
                <h6 class="white--text mt-8">DOWN JACKETS</h6>
      ...
      <v-row>
        ...
        <v-col cols="3" class="py-0 pr-0 mt-n3">
          <v-card flat outlined tile>
            ...
            <v-list dense class="mt-n5">
              <v-list-item v-for="style in styles" :key="style.title">
                <v-list-item-content>
                  <v-list-item-title v-text="style.title" class="ml-8">

                  </v-list-item-title>
                </v-list-item-content>
                <v-list-item-action>
                  <v-list-item-subtitle v-text="style.count">
          ...
          <v-card flat outlined tile>
            ...
            <v-toolbar flat>
              <v-text-field placeholder="$50" filled rounded dense class="mx-2">              
              </v-text-field>
              <v-text-field placeholder="$1900" filled rounded dense class="mx-2">              
              </v-text-field>
            </v-toolbar>
            <v-range-slider color="blue" max="40" min="-30">
            </v-range-slider>
          </v-card>
          <v-card flat outlined tile>
            <v-toolbar flat>
            ...
            <v-list dense class="mt-n5">
              <v-list-item v-for="brand in brands" :key="brand.title">
                <v-list-item-content>
                  <v-list-item-title v-text="brand.title" class="ml-6">
                  </v-list-item-title>
                </v-list-item-content>
                <v-list-item-action>
                  <v-checkbox color="primary" v-model="brand.state">                    
                  </v-checkbox>
                </v-list-item-action>
              </v-list-item>
            </v-list>
          ...
          <v-card flat outlined tile>
            ...
            <v-chip-group column multiple>
              ...
              <v-chip filter  color="#FF8500" text-color="white"></v-chip>
            ...
            <v-col cols="12" sm="4" v-for="(clothe, i) in clothes" :key="i" :class="clothe.class">
              <v-hover v-slot:default="{hover}">
                <v-card height="300" align="center" flat outlined tile>
                  ...
                  <v-img :src=clothe.image width="200" height="200" contain>
                  </v-img>
      ...
      <v-row>
        ...
        <v-col cols="12" sm="12">
          <h6 class="text-center grey--text">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum, sunt sapiente placeat voluptatibus ea vero fugit hic! Architecto id reiciendis voluptates nobis, tempora ipsum reprehenderit laborum nemo qui fuga magnam.
          </h6>
        </v-col>
        <v-col cols="12" sm="12">
          <v-card flat color="transparent" class="d-flex justify-center">
            <v-text-field placeholder="Enter your email" rounded class="shrink" background-color="grey" filled append-icon="mdi-email-outline" dense>

      ...
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-card-text class="grey--text pt-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, molestiae iure quia rerum odit doloribus minima, nihil iusto esse culpa natus perferendis earum sequi recusandae tempora corrupti reprehenderit veritatis hic.
          </v-card-text>
